    ...
    : IdentityDbContext<ApplicationUser>(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>().HasData(
            new Product { Id = 1, Name = "Laptop Apple MacBook Air 13-inch", ShortDescription = "Laptop Apple MacBook", LongDescription = "High-performance Laptop Apple MacBook", ThumbnailUrl = "/images/laptop1.jpg", PdfUrl = "/docs/laptop.pdf", CategoryId = 1, Price = 6499.99m, Stock = 12, UnitsSold = 50, AverageRating = 4.7 },
            new Product { Id = 2, Name = "Smartphone", ShortDescription = "Android Phone", LongDescription = "Latest Android smartphone", ThumbnailUrl = "/images/phone1.jpg", PdfUrl = "/docs/phone.pdf", CategoryId = 1, Price = 2999.50m, Stock = 35, UnitsSold = 120, AverageRating = 4.5 },
            new Product { Id = 3, Name = "Headphones", ShortDescription = "Noise-canceling", LongDescription = "Wireless noise-canceling headphones", ThumbnailUrl = "/images/headphones1.jpg", PdfUrl = "/docs/headphones.pdf", CategoryId = 1, Price = 499.99m, Stock = 20, UnitsSold = 75, AverageRating = 4.3 },
            new Product { Id = 4, Name = "C# Programming", ShortDescription = "C# Book", LongDescription = "Learn C# from scratch", ThumbnailUrl = "/images/csharp1.jpg", PdfUrl = "/docs/csharp.pdf", CategoryId = 2, Price = 149.99m, Stock = 80, UnitsSold = 40, AverageRating = 4.2 },
            new Product { Id = 5, Name = "Blazor Guide", ShortDescription = "Blazor Development", LongDescription = "Master Blazor and .NET", ThumbnailUrl = "/images/blazor1.jpg", PdfUrl = "/docs/blazor.pdf", CategoryId = 2, Price = 199.99m, Stock = 50, UnitsSold = 65, AverageRating = 4.6 },
            new Product { Id = 6, Name = "Software Design Patterns", ShortDescription = "Design Patterns", LongDescription = "Understand software design principles", ThumbnailUrl = "/images/designpatterns1.jpg", PdfUrl = "/docs/designpatterns.pdf", CategoryId = 2, Price = 169.00m, Stock = 40, UnitsSold = 58, AverageRating = 4.1 },
            new Product { Id = 7, Name = "Office Chair", ShortDescription = "Ergonomic Chair", LongDescription = "Comfortable office chair with lumbar support", ThumbnailUrl = "/images/chair1.jpg", PdfUrl = "/docs/chair.pdf", CategoryId = 3, Price = 899.99m, Stock = 18, UnitsSold = 34, AverageRating = 4.4 },
            new Product { Id = 8, Name = "Desk", ShortDescription = "Wooden Desk", LongDescription = "Modern wooden office desk", ThumbnailUrl = "/images/desk1.jpg", PdfUrl = "/docs/desk.pdf", CategoryId = 3, Price = 1149.99m, Stock = 15, UnitsSold = 22, AverageRating = 4.3 },
            new Product { Id = 9, Name = "Bookshelf", ShortDescription = "Wooden Shelf", LongDescription = "Spacious bookshelf for organizing books", ThumbnailUrl = "/images/bookshelf1.jpg", PdfUrl = "/docs/bookshelf.pdf", CategoryId = 3, Price = 599.50m, Stock = 25, UnitsSold = 38, AverageRating = 4.2 },
            new Product { Id = 10, Name = "Table Lamp", ShortDescription = "LED Lamp", LongDescription = "Energy-efficient LED table lamp", ThumbnailUrl = "/images/lamp1.jpg", PdfUrl = "/docs/lamp.pdf", CategoryId = 3, Price = 149.00m, Stock = 60, UnitsSold = 55, AverageRating = 4.5 }
        );
